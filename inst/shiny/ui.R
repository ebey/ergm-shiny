...
tabPanel(title='Help', value='tab8',
         sidebarLayout(position = 'right',
                       ...
                       mainPanel(
                         h5(tags$u('Help with statnetWeb PATH')),
                         p("This app is maintained on GitHub. To request new features or report a bug,",
                           "you may interact with the",
                           a("repository", href="https://github.com/ebey/statnetWeb-ADP",
                             target="_blank"),
                           "or email ebeylerian@path.org"),
                         h5(tags$u('More on statnet software')),
                         p("The homepage of the statnet project is", a("here,", href = "https://statnet.csde.washington.edu/trac",
                                                                       target = "_blank"),
                           "where you can find workshop materials, tutorials and publications to learn more about",
                           "network modeling methods."),
                         p("The statnet team has a users group mailing list,",
                           "where you can contact them with questions, comments or suggestions"),
